...
We have identified some well known players who excel at shooting three pointers. The graphs show each one of these top players' career-long progress of 3-pointer success rate. Though these players might have played for different teams and during time, we observed some interesting trends. First, three point shooting success rate generally go up at the begining, which is likely due to the fact that they receive best in class training to help them improve their shooting skills. After career-high, the three point success rates would go down towards the end of his career. We also wanted to analyze whether players can drastically improve their three point shooting skills over time or the skill is rather something people are borned with. By above regression and below graphs, there is no dramatic increase in 3-pointer success rate. Maybe if we can check the players' data from NCAA or high school league, there might be different insight. However, based on NBA data, it does not appear that top three point shooting players can significantly improve their three point shooting skills over time, except some initial uptick at the very beginning of their NBA careers for some players.
