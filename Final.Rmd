...
In the 2018-2019 NBA season, we saw many new 3 pointers records. For example, Klay Thompson from Golden State Warriors, made 14 3-pointers in Chicago last October. ([link](https://ftw.usatoday.com/2018/10/klay-thompson-14-3-pointers-nba-record)) James Harden, Houston’s top 3-point shooter, recorded 2nd longest 30-point games streak, 32 games, in last Feb., which is the first record change after 1962. ([link](http://www.espn.com/nba/story/_/id/26081187/james-harden-historic-30-point-streak-ends-28-win-vs-atlanta)) Also, Klay Thompson succeeded 10 consecutive 3-pointers in last Jan. ([link](https://www.newsweek.com/klay-thompson-three-pointers-nba-records-golden-state-warriors-los-angeles-1299559)) Thus, we would like to answer questions on the historical development, correlation with other factors such as team's standing, player's age, other shoots, and others. 

## Methodology

To acquire detailed historical data, we used nbastatR package. ([link](http://asbcllc.com/nbastatR/index.html)) This is a well-made open-source package that has several functions to get the NBA data. We found that not all the functions are working and some of them are duplicates. However, it was successful to find the fundamental data to research on 3-pointers. 
