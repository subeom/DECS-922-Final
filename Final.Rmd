...
fgplayerhometownState <- aggregate(fgplayerhometown[, 2:7], list(fgplayerhometown$State), sum) %>% mutate(state=tolower(fgplayerhometownState[,1])) %>% select(state, fgm, ftm, fg3m, fga, fta, fg3a)
